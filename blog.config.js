...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '香菇肉饼', // 您的昵称 例如 tangly1024
  ...
  CONTACT_CSDN: process.env.NEXT_PUBLIC_CONTACT_CSDN || 'https://blog.csdn.net/m0_46285401?spm=1000.2115.3001.5343', // CSDN
  CONTACT_GITEE: process.env.NEXT_PUBLIC_CONTACT_GITEE || 'https://gitee.com/sara02', // Gitee仓库
